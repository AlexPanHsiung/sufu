...
if($this->config->get('mta_ypx_status')) {		
	...
	if($this->customer->isLogged()) {
		...
		$_aff_info = $this->model_account_customer->getAffiliate($this->customer->getId());
		if($_aff_info && $_aff_info['status']) $this->document->addScript('catalog/view/javascript/mta_als.js.php?t=' . urlencode($_aff_info['tracking'])); 
	}	
} else {
...
//+mod by yp end
		...
		$this->document->addScript('catalog/view/javascript/clipboard/clipboard.min.js', 'footer'); //新增點我複製按鈕js
