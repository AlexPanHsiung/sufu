	...
	public function index() {
		...
		if ($product_info) {
			...
			if ($product_info['image']) {
				...
				$fbThumb = $this->model_tool_image->resize($product_info['image'], 1200, 630);
			} else {
				$data['thumb'] = '';
				$fbThumb = '';
			}
			...
			$data['text_qrcode'] = $this->language->get('text_qrcode');
			if($affiliate_info){
				$data['product_qrcode'] = $google_qrcode . str_replace('&amp;', '%26', $this->url->link('product/product', 'product_id=' . $product_id . '&tracking=' . $affiliate_info['tracking']));
			}else{
				$data['product_qrcode'] = $google_qrcode . str_replace('&amp;', '%26', $this->url->link('product/product', 'product_id=' . $product_id));
			}
			/* ===================end=================== */
			...
			$data['header'] = $this->load->controller('common/header', Array(
				'fbThumb' => Array(
					'fbThumbSrc' => $fbThumb,
					'fbThumbWidth' => 1200,
					'fbThumbHeight' => 630
