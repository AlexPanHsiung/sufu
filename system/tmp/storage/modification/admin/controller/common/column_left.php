...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		...
		if($this->user->hasPermission('access', 'extension/module/cash_transactions')) {
			$sale[] = array(
				'name'	   => $this->language->get('text_cash_transactions'),
				'href'     => $this->url->link('extension/module/cash_transactions', 'user_token=' . $this->session->data['user_token'], true),
				'children' => array()
			);
		}
