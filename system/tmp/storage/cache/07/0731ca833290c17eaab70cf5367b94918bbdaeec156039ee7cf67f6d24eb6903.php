...
/* extension/module/mta/mta_pds_dt.twig */
class __TwigTemplate_87d08dc96ef6b5771f5b8c3f622faa30ed9e58c36086b43d14dcd6c205e68056 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div style=\"background-color:#efefef;border:2px solid #ababab;z-index:99999999;display:none;\" id=\"affiliate_dt_overlay_div\"><div style=\"text-align:right;padding-right:5px;\"><a class=\"overlay_close\">";
...
";
        ...
        if ((isset($context["show_save_button"]) ? $context["show_save_button"] : null)) {
            // line 34
            echo "<div style=\"text-align:center;\"><hr /><input type=\"button\" id=\"affiliate_dt_save_button\" value=\"\" /></div>
";
        }
        // line 36
...
";
    ...
    {
        return "extension/module/mta/mta_pds_dt.twig";
    }
