...
class __TwigTemplate_cbe5245598ddef1fcc9689f4c7a187ef7c9f822c568b396810344811f9812002 extends Twig_Template
{
  ...
  ";
        ...
        if ( !(isset($context["logged"]) ? $context["logged"] : null)) {
            ...
            echo "</a> <a href=\"";
            echo (isset($context["affiliate_login"]) ? $context["affiliate_login"] : null);
            echo "\" class=\"list-group-item\"> ";
...
";
    ...
    {
        return array (  114 => 13,  106 => 11,  104 => 10,  65 => 9,  53 => 7,  51 => 6,  44 => 5,  24 => 3,  22 => 2,  19 => 1,);
    }
}
/* <div class="list-group">*/
/*   {% if not logged %}*/
/*   <a href="{{ login }}" class="list-group-item">{{ text_login }}</a> <a href="{{ register }}" class="list-group-item">{{ text_register }}</a> <a href="{{ affiliate_login }}" class="list-group-item"> {{ text_be_affiliate }} </a> <a href="{{ forgotten }}" class="list-group-item">{{ text_forgotten }}</a>*/
/*   {% endif %}*/
