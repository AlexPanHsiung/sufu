...
class __TwigTemplate_5c163d7a348e771636fee37422d113392287fd744138c9e13e1de75d3d73a13e extends Twig_Template
{
...
";
        ...
        if ((isset($context["mta_status"]) ? $context["mta_status"] : null)) {
            // line 1465
            echo "<script type=\"text/javascript\" src=\"view/javascript/jquery.migrate.min.js\"></script>
...
\tvar _commission = \$('[name=\"commission\"]').val();
\t\$('[name=\"commission\"]').parent().parent().remove();
\t\$('#form-customer').prepend('<input type=\"hidden\" name=\"commission\" value=\"'+_commission+'\" />');

\tvar _html = '<div class=\"form-group\"><label class=\"col-sm-2 control-label\" id=\"level_span\">";
            // line 1474
            echo (isset($context["text_level_jsstr"]) ? $context["text_level_jsstr"] : null);
            echo "  ";
            echo (isset($context["level"]) ? $context["level"] : null);
            echo "</label><div class=\"col-sm-10\"><a href=\"";
            echo (isset($context["link_downline"]) ? $context["link_downline"] : null);
            echo "\" target=\"_blank\">";
            echo (isset($context["text_view_downline_jsstr"]) ? $context["text_view_downline_jsstr"] : null);
            echo "</a></div></div>';
\t_html += '<div class=\"form-group\"><label class=\"col-sm-2 control-label\" for=\"input-parent-affiliate-id\">";
            // line 1475
            echo (isset($context["entry_parent_jsstr"]) ? $context["entry_parent_jsstr"] : null);
            echo "</label><div class=\"col-sm-10\"><div class=\"input-group\"><input type=\"hidden\" name=\"parent_affiliate_id\" value=\"";
            echo (isset($context["parent_affiliate_id"]) ? $context["parent_affiliate_id"] : null);
            echo "\" /><input type=\"hidden\" name=\"parent_affiliate_name\" value=\"";
            echo (isset($context["parent_affiliate_name_jsstr"]) ? $context["parent_affiliate_name_jsstr"] : null);
            echo "\" /><span id=\"parent_affiliate_span\">';
\t";
            // line 1476
            if ((isset($context["parent_affiliate_id"]) ? $context["parent_affiliate_id"] : null)) {
                // line 1477
                echo "\t_html += '<a href=\"";
                echo (isset($context["parent_affiliate_link_jsstr"]) ? $context["parent_affiliate_link_jsstr"] : null);
                echo "\" target=\"_blank\">";
                echo (isset($context["parent_affiliate_name_jsstr"]) ? $context["parent_affiliate_name_jsstr"] : null);
                echo "</a>';
\t";
...
\t";
            ...
            // line 1481
            echo "\t_html += '</span><div class=\"btn-group\"><button type=\"button\" rel=\"#affiliate_dt_overlay_div\" id=\"affiliate_dt_overlay_open\" class=\"btn btn-default\">";
            echo (isset($context["text_select_affiliate_jsstr"]) ? $context["text_select_affiliate_jsstr"] : null);
            echo "</button><button type=\"button\" id=\"affiliate_set_none\" class=\"btn btn-default\">";
            echo (isset($context["text_set_none_jsstr"]) ? $context["text_set_none_jsstr"] : null);
            echo "</button></div></div></div></div><div class=\"form-group\"><label class=\"col-sm-2 control-label\" for=\"input-scheme\">";
            echo (isset($context["entry_scheme_jsstr"]) ? $context["entry_scheme_jsstr"] : null);
            echo "</label><div class=\"col-sm-10\"><select name=\"scheme\" id=\"input-scheme\" class=\"form-control\"><option value=\"0\"";
            if ( !(isset($context["scheme_id"]) ? $context["scheme_id"] : null)) {
                echo " selected=\"selected\"";
            }
            echo ">";
            echo (isset($context["option_default_jsstr"]) ? $context["option_default_jsstr"] : null);
            echo "</option>';
\t";
            // line 1482
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["schemes_jsstr"]) ? $context["schemes_jsstr"] : null));
            foreach ($context['_seq'] as $context["_id"] => $context["_name"]) {
                // line 1483
                echo "\t_html += '<option value=\"";
                echo $context["_id"];
                echo "\"";
                if (((isset($context["scheme_id"]) ? $context["scheme_id"] : null) == $context["_id"])) {
                    echo " selected=\"selected\"";
                }
                echo ">";
                echo $context["_name"];
...
\t\t\t\t\t\t";
            ...
            $context = array_intersect_key($context, $_parent) + $_parent;
            // line 1485
            echo "\t_html += '</select></div></div>';
\t\$('#tab-affiliate fieldset:first').append(_html);
\t\$.ajax({
\t\turl: 'index.php?route=extension/module/mta/mta_pds/datatable&user_token=";
            // line 1488
            echo (isset($context["user_token"]) ? $context["user_token"] : null);
            echo "&add_js=affiliate_form',
\t\ttype: 'get',
\t\tdataType: 'html',
...
\t});
\t
\tvar _html = '<div class=\"form-group\"><label class=\"col-sm-2 control-label\" for=\"input-affiliate-id\">";
            // line 1496
            echo (isset($context["entry_parent_jsstr"]) ? $context["entry_parent_jsstr"] : null);
            echo "</label><div class=\"col-sm-10\" id=\"caffiliate_td\"><div class=\"input-group\"><span>';
\t";
            // line 1497
            if ((isset($context["affiliate_id"]) ? $context["affiliate_id"] : null)) {
                // line 1498
                echo "\t_html += '<a href=\"";
                echo (isset($context["affiliate_link_jsstr"]) ? $context["affiliate_link_jsstr"] : null);
                echo "\" target=\"_blank\">";
                echo (isset($context["affiliate_name_jsstr"]) ? $context["affiliate_name_jsstr"] : null);
                echo "</a>';
\t";
            } else {
                // line 1500
...
\t";
            ...
            // line 1502
            echo "\t_html += '</span><div class=\"btn-group\"><button class=\"btn btn-default\" type=\"button\" rel=\"#caffiliate_dt_overlay_div\" id=\"caffiliate_dt_overlay_open\">";
            echo (isset($context["text_select_affiliate_jsstr"]) ? $context["text_select_affiliate_jsstr"] : null);
            echo "</button><button class=\"btn btn-default\" type=\"button\" id=\"caffiliate_set_none\">";
            echo (isset($context["text_set_none_jsstr"]) ? $context["text_set_none_jsstr"] : null);
            echo "</button><input type=\"hidden\" name=\"affiliate_id\" value=\"";
            echo (isset($context["affiliate_id"]) ? $context["affiliate_id"] : null);
            echo "\" id=\"input-affiliate-id\" /><input type=\"hidden\" name=\"affiliate_name\" value=\"";
            echo (isset($context["affiliate_name_jsstr"]) ? $context["affiliate_name_jsstr"] : null);
...
/* 	$('#form-customer').prepend('<input type="hidden" name="commission" value="'+_commission+'" />');*/
/* */
/* 	var _html = '<div class="form-group"><label class="col-sm-2 control-label" id="level_span">{{ text_level_jsstr }}  {{ level }}</label><div class="col-sm-10"><a href="{{ link_downline }}" target="_blank">{{ text_view_downline_jsstr }}</a></div></div>';*/
/* 	_html += '<div class="form-group"><label class="col-sm-2 control-label" for="input-parent-affiliate-id">{{ entry_parent_jsstr }}</label><div class="col-sm-10"><div class="input-group"><input type="hidden" name="parent_affiliate_id" value="{{ parent_affiliate_id }}" /><input type="hidden" name="parent_affiliate_name" value="{{ parent_affiliate_name_jsstr }}" /><span id="parent_affiliate_span">';*/
/* 	{% if parent_affiliate_id %}*/
/* 	_html += '<a href="{{ parent_affiliate_link_jsstr }}" target="_blank">{{ parent_affiliate_name_jsstr }}</a>';*/
/* 	{% else %}*/
/* 	_html += '{{ text_none }}';*/
/* 	{% endif %}*/
/* 	_html += '</span><div class="btn-group"><button type="button" rel="#affiliate_dt_overlay_div" id="affiliate_dt_overlay_open" class="btn btn-default">{{ text_select_affiliate_jsstr }}</button><button type="button" id="affiliate_set_none" class="btn btn-default">{{ text_set_none_jsstr }}</button></div></div></div></div><div class="form-group"><label class="col-sm-2 control-label" for="input-scheme">{{ entry_scheme_jsstr }}</label><div class="col-sm-10"><select name="scheme" id="input-scheme" class="form-control"><option value="0"{% if not scheme_id %} selected="selected"{% endif %}>{{ option_default_jsstr }}</option>';*/
/* 	{% for _id, _name in schemes_jsstr %}*/
/* 	_html += '<option value="{{ _id }}"{% if scheme_id == _id %} selected="selected"{% endif %}>{{ _name }}</option>';*/
/* 						{% endfor %}*/
/* 	_html += '</select></div></div>';*/
/* 	$('#tab-affiliate fieldset:first').append(_html);*/
/* 	$.ajax({*/
/* 		url: 'index.php?route=extension/module/mta/mta_pds/datatable&user_token={{ user_token }}&add_js=affiliate_form',*/
/* 		type: 'get',*/
/* 		dataType: 'html',*/
/* 		success: function(html) {*/
/* 			$('#content').append(html);*/
...
/* 	});*/
/* 	*/
/* 	var _html = '<div class="form-group"><label class="col-sm-2 control-label" for="input-affiliate-id">{{ entry_parent_jsstr }}</label><div class="col-sm-10" id="caffiliate_td"><div class="input-group"><span>';*/
/* 	{% if affiliate_id %}*/
/* 	_html += '<a href="{{ affiliate_link_jsstr }}" target="_blank">{{ affiliate_name_jsstr }}</a>';*/
/* 	{% else %}*/
/* 	_html += '{{ text_none_jsstr }}';*/
/* 	{% endif %}*/
/* 	_html += '</span><div class="btn-group"><button class="btn btn-default" type="button" rel="#caffiliate_dt_overlay_div" id="caffiliate_dt_overlay_open">{{ text_select_affiliate_jsstr }}</button><button class="btn btn-default" type="button" id="caffiliate_set_none">{{ text_set_none_jsstr }}</button><input type="hidden" name="affiliate_id" value="{{ affiliate_id }}" id="input-affiliate-id" /><input type="hidden" name="affiliate_name" value="{{ affiliate_name_jsstr }}" /></div></div></div></div>';*/
/* 	$('#tab-customer').append(_html);*/
/* 	$.ajax({*/
/* 		url: 'index.php?route=extension/module/mta/mta_pds/datatable&user_token={{ user_token }}&add_js=customer',*/
/* 		type: 'get',*/
/* 		dataType: 'html',*/
/* 		success: function(html) {*/
/* 			$('#content').append(html);*/
