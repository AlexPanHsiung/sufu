...
class ControllerExtensionModuleMstoreappBlocks extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['elevation'])) {
			$data['elevation'] = $this->request->post['elevation'];
		} elseif (!empty($blocks)) {
			$data['elevation'] = $blocks['elevation'];
		} else {
			$data['elevation'] = 1;
		}
	...
	public function install() {
		...
		$data = array();
		$data['module_mstoreapp_blocks_status'] = '1';
		$this->model_setting_setting->editSetting('module_mstoreapp_blocks', $data);
	...
	public function uninstall() {
		...
		$this->load->model('setting/setting');
		$data = array();
		$data['module_mstoreapp_blocks_status'] = '0';
		$this->model_setting_setting->editSetting('module_mstoreapp_blocks', $data);
