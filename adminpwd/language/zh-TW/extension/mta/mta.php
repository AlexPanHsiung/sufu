...
$_['text_eternal_description'] = '通常，噹噹前的銷售會員級別高於級別數時，較低級別的會員不會獲得任何佣金。例如。 如果您具有4層設置，並且會員處於6級，則6、5、4、3級的會員將獲得佣金，而2級和1級的會員將不會獲得任何佣金。 但是，如果將<strong>總是包含在佣金中</strong>設置為2，則在相同情況下，佣金將在6,5,2,1之間分配，而4和3將不會獲得佣金。';
//$_['text_unconverted_affiliates'] = 'Affiliates not yet converted to multitier system';
$_['text_unconverted_affiliates'] = 'Affiliates關聯尚未轉換為多層系統';
