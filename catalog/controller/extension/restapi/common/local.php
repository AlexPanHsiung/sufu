...
class ControllerExtensionRestapiCommonLocal extends Controller {
	public function index() {
		...
		$data['entry_affiliate_company'] = $this->language->get('entry_company');
		$data['entry_affiliate_website'] = $this->language->get('entry_website');
		$data['entry_affiliate_tax'] = $this->language->get('entry_tax');
		$data['entry_affiliate_bank_name'] = $this->language->get('entry_bank_name');
		$data['entry_affiliate_bank_branch_number'] = $this->language->get('entry_bank_branch_number');
		$data['entry_affiliate_bank_account_name'] = $this->language->get('entry_bank_account_name');
		$data['entry_affiliate_bank_account_number'] = $this->language->get('entry_bank_account_number');
		/* by toastguo */
		...
		$data['text_affiliate_register'] = $this->language->get('text_affiliate_register');
		/* by toastguo */
