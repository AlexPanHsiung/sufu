...
class ModelCheckoutOrder extends Model {
	...
	public function getThisMonthTotal($customer_id){
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order` WHERE `customer_id` = '" . (int)$customer_id . "' AND month(`date_added`) = month(curdate())");
		$thisMonth = 0;
