...
<div class="box-content">
	<ul class="list-box">
				...
				<div class="box-heading"><?php echo $heading_title; ?></div>
					<?php foreach ($marketplace_account_menu_sequence as $key => $menu_option) {
						if(isset($marketplace_allowed_account_menu) && $marketplace_allowed_account_menu && in_array($key,$marketplace_allowed_account_menu)) {
							if($key == 'asktoadmin') { ?>
								<li><a id="ask-to-admin" data-toggle="modal" data-target="#myModal-seller-mail">
									<?php echo $menu_option; ?>
								</a>
							</li>
							<?php } else if($key == 'notification') { ?>
								<li><a id="notification" data-toggle="modal" data-target="#myModal-notification">
									<?php echo $menu_option; ?>
								</a></li>
							<?php } else { ?>
							<li><a href="<?php echo $account_menu_href[$key]; ?>" >
									<?php echo $menu_option; ?>
								</a>
							</li>
							<?php } ?>
		...
		<?php }else{ ?>
			<li>
			<a href="<?php echo $want_partner; ?>"><?php echo $text_becomePartner; ?></a>
			</li>
		<?php } ?>
	</ul>
	</div>
      ...
      <div class="product-layout product-grid col-xs-12">
        <div class="product-thumb">
          ...
          <div class="text-center">
            ...
            <img src="<?php echo $partner['thumb']; ?>" alt="<?php echo $partner['name']; ?>" title="<?php echo $partner['name']; ?>" class="img-circle" style="box-shadow:0px 0px 5px 2px #f1f1f1;"/>
            </a>
	        ...
	        <div class="product-thumb seller-thumb" id="<?php echo $product['product_id']; ?>">
	          ...
	          <div>
	            ...
	            <div class="button-group">
                   <a onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-original-title="<?php echo $button_cart; ?>" style="display:inline-block;"><i class="fa fa-shopping-cart"></i></a>
                 <a onclick="wishlist.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-original-title="<?php echo $button_wishlist; ?>" style="display:inline-block;"><i class="fa fa-heart"></i></a>
                 <a onclick="compare.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-original-title="<?php echo $button_compare; ?>" style="display:inline-block;"><i class="fa fa-exchange"></i></a>
              </div>
	          </div>
	        </div>
	      </div>
			...
			<div class="modal-body">
				<div class="form-group">
					<ul style="display:inline-flex;margin-left:-8%;">
						...
						<li style="display: block; overflow: auto;"><a href="<?php echo $view_all; ?>"><span class="label label-warning"><?php echo $processing_status_total; ?></span><?php echo $text_processing_status; ?></a></li>
						<li style="display: block; overflow: auto;margin-left:40px;margin-right:40px;"><a href="<?php echo $view_all; ?>"><span class="label label-success"><?php echo $complete_status_total; ?></span><?php echo $text_complete_status; ?></a></li>
						<li style="display: block; overflow: auto;"><a href="<?php echo $view_all; ?>"><span class="label label-danger"><?php echo $return_total; ?></span><?php echo $text_return; ?></a></li>
					</ul>
				...
				<div class="form-group">
					<ul style="display:inline-flex;margin-left:-8%;">
						...
						<!-- <li style="display: block; overflow: auto;"><span class="label label-warning"><?php echo $stock_total; ?></span><?php echo $text_stock; ?></li> -->
						<li style="display: block; overflow: auto;margin-left:40px;margin-right:40px;"><a href="<?php echo $view_all; ?>"><span class="label label-success"><?php echo $product_review_total; ?></span><?php echo $text_notifications; ?></a></li>
					</ul>
				...
				<div class="form-group">
					<ul style="display:inline-flex;margin-left:-8%;">
						...
						<li style="display: block; overflow: auto;margin-right:40px;"><a href="<?php echo $view_all; ?>"><span class="label label-success"><?php echo $seller_review_total; ?></span><?php echo $text_entry_review; ?></a></li>
					</ul>
