          ...
          <div class="detail-container-inner">
            ...
            <div class="details">
              ...
              <div class="lower-detail">
                ...
                <!-- <br/> -->
                <?php for ($i = 1; $i <= $feedback_total['total']; $i++) { ?>
                  <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                <?php } ?>
                <?php for ($j = 1; $j <= 5 - $feedback_total['total']; $j++) { ?>
                  <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-2x"></i></span>
                <?php } ?>
              </div>
            </div> <!-- details -->
        ...
        <ul class="mp-list-group" id="main-tab">
          ...
          <li class="mp-list-group-item">
            <a data-tab="#tab-reviews">
              ...
              <?php echo $text_reviews.' ('.($feedback_total ? $feedback_total : '0').')'; ?>
            </a>
          </li>
          <?php } ?>
...
function display(view) {
  ...
  if (view == 'list') {
    ...
    $('.product-grid').css({'display':'inline-block'});
