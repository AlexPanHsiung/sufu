			...
			<?php foreach ($categories as $category) { ?>
				<?php if ($category['category_id'] == $category_id) { ?>
					<li class="mp-list-group-item mp-active">
						<a class="default-work" data-collection-url="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a>
					</li>
					<?php if ($category['children']) { ?>
						<?php foreach ($category['children'] as $child) { ?>
							<?php if ($child['category_id'] == $child_id) { ?>
								<li class="mp-list-group-item mp-active">
									<a class="default-work" data-collection-url="<?php echo $child['href']; ?>">&nbsp;&nbsp;&nbsp;- <?php echo $child['name']; ?></a>
								</li>
							<?php } else { ?>
...
<?php if ($products) { ?>
  ...
  ?>
  <div class="product-grid" style="display:none;" <?php if($theme_options->get('default_list_grid') == '1') { echo ' class="active"'; } ?>>
  	<div class="row">
