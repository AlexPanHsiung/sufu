      ...
      <div class="row">
        <ul class="nav nav-tabs" style="display:flex;">
          ...
          <li class="mp-list-group-item" style="border-top: solid 5px #2BA9EF !important;">
            ...
            <?php echo $text_collection.' ('.($collection_total ? $collection_total : '0').')'; ?></a>
          </li>
          <?php } ?>
          ...
          <li class="mp-list-group-item" style="border-top: solid 5px #2BA9EF !important;">
            ...
            <?php echo $text_reviews.' ('.($feedback_total ? round($feedback_total,1) : '0').')'; ?></a>
          </li>
          <?php } ?>
          ...
          <li class="mp-list-group-item" style="border-top: solid 5px #2BA9EF !important;">
            ...
            <?php echo $text_product_reviews.' ('.($product_feedback_total ? $product_feedback_total : '0').')'; ?></a>
          </li>
          <?php } ?>
        </ul>
