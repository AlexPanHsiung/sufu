      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-shipping" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <input type="text" name="shipping_add_flatrate" value="<?php if (isset($shipping_add_flatrate_amount)) { ?><?php echo $shipping_add_flatrate_amount; ?><?php } ?>" placeholder="<?php echo $add_flatrate; ?>" id="input-flatrate" class="form-control" />
