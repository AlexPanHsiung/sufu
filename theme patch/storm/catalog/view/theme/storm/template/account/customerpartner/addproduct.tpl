...
<style type="text/css">
  ...
  .note-editor .fa,.note-editor span{
    color: #fff;
  }
...
<?php } ?>
      <h1>
        <?php echo $heading_title_add_product; ?>
      ...
      <legend><i class="fa fa-pencil"></i> <?php echo $heading_title_add_product; ?></legend>
          ...
          <ul class="nav nav-tabs" id="languages">
            ...
            <li class="<?php if($count == 0) echo 'active'; $count++; ?>">
              <a href="#language<?php echo $language['language_id']; ?>" data-toggle="tab">
                <img src="catalog/language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" />
            ...
            <?php foreach ($languages as $language) { ?>
              <div class="form-group">
                ...
                <div class="col-sm-9 input-group">
                  ...
                  <input type="text" name="keyword[<?php echo $current_store; ?>][<?php echo $language['language_id']; ?>]" value="<?php echo $keyword[$current_store][$language['language_id']]; ?>" placeholder="<?php echo $entry_keyword; ?>" id="input-keyword" class="form-control" />
...
$('input[name=\'category\']').autocomplete({
  ...
  select: function(item) {
    ...
    <?php } ?>
  // <!-- membership codes starts here -->
     <?php if(isset($wk_seller_group_status) && $wk_seller_group_status && isset($wk_seller_group_single_category) && $wk_seller_group_single_category) { ?>
...
function addImage() {
  ...
  html += '  <tr>';
  html += '  <td class="text-left"><div style="width:100px;height:100px;overflow:hidden" class="img-thumbnail wk_upload_img"><img id="thumb' + image_row + '-thumb-image" src="<?php echo $placeholder; ?>" alt="" title=""/></div><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="thumb' + image_row + '-target-image"/><div class="btn-group imgoption" style="width: 41%;"><button class="btn btn-danger btn-sm delete_img" type="button">Remove</button></div></td>';
...
<?php } ?>
 <!-- membership codes starts here -->
<?php if(isset($wk_seller_group_status) && $wk_seller_group_status && $wk_seller_group_membership_type && $wk_seller_group_membership_type != 'product') {  ?>
