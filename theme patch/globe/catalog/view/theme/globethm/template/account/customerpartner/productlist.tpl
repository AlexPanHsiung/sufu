...
include('catalog/view/theme/' . $config->get('theme_' . $config->get('config_theme') . '_directory') . '/template/new_elements/wrapper_top.tpl'); ?>
              ...
              <tr>
                ...
                <td class="text-right">
                  ...
                  <?php } else if($product['action']) { ?>
                    ...
                    <?php } ?>
                    <?php if(!$product['status']) { ?>
                        <a href="<?php echo $product['productPreviewLink']; ?>" target="_blank" class="btn btn-info"><span data-toggle="tooltip" title="<?php echo $text_product_preview; ?>"><i class="fa fa-television"></i></span></a>
                    <?php } ?>
                </td>
                 <!-- membership codes ends here -->
              </tr>
  ...
  <div class="buttons clearfix">
    <div class="pull-left"><a href="<?php echo $insert; ?>" class="btn btn-default"><?php echo $button_insert; ?></a></div>
    <div class="pull-right">
      <a onclick="$('#form-product').submit();" class="btn btn-danger"><?php echo $button_delete; ?></a>
    </div>
  </div>
    </fieldset>
