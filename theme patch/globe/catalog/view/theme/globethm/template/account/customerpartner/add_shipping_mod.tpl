      ...
      <?php if($isMember) { ?>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-shipping" class="form-horizontal">
          ...
          <div class="pull-right">
            <a onclick="$('#form-delete').submit();" class="btn btn-danger"><?php echo $button_delete; ?></a>
            <button type="submit" form="form-shipping" class="btn btn-primary"><?php echo $button_next; ?></button>
          </div>
        </div>
        </form>
