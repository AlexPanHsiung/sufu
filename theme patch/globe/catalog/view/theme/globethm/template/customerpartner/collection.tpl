				...
				<div class="product-layout product-list col-xs-12">
				  <div class="product-thumb">
				  	<?php if (isset($product['thumb']) && $product['thumb']) { ?>
				  		<div class="image"><a href="<?php echo $product['href']; ?>" class="default-work"><img style="margin-top:10%;" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" /></a></div>	
				  	<?php } ?>
				    ...
				    <div>
				      ...
				      <div class="add-to-cart"><a onclick="cart.add('<?php echo $product['product_id']; ?>');" class="button"><?php echo $button_cart; ?></a></div>
	  					...
	  					<a onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><?php echo $button_wishlist; ?></a>
	  					<a onclick="compare.add('<?php echo $product['product_id']; ?>');"><?php echo $button_compare; ?></a>
