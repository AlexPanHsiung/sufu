	  ...
	  <div class="box-content">
		<ul class="list-box">
			<?php if($chkIsPartner){ ?>
						...
						<?php  foreach ($marketplace_account_menu_sequence as $key => $menu_option) {
							if(isset($marketplace_allowed_account_menu) && $marketplace_allowed_account_menu && in_array($key,$marketplace_allowed_account_menu)) {
								...
								<?php } else if($key == 'notification') { ?>
									<li><a id="notification" class=""  data-toggle="modal" data-target="#myModal-notification">
										<?php echo $menu_option; ?>
									</a></li>
								<?php } else { ?>
				...
				<?php } ?>
			<?php }else{ ?>
				<li><a href="<?php echo $want_partner; ?>"><?php echo $text_becomePartner; ?></a></li>
			<?php } ?>
		</ul>
	</div>
	</div>
	        ...
	        <div class="product-thumb seller-thumb" id="<?php echo $product['product_id']; ?>">
	          ...
	          <div>
	            ...
	            <div class="button-group">
	              <input type="button" value="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');" rel="<?php echo $product_id; ?>" data-loading-text="<?php echo $text_loading; ?>" class="button" />
	            </div>
	            <div class="links">
		        	<a onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i> <?php echo $button_wishlist; ?></a>
		        	<a onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-refresh"></i> <?php echo $button_compare; ?></a>
		        </div>
	          </div>
	        </div>
	      </div>
	...
	<div class="modal fade" id="myModal-seller-info" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  	<div class="modal-dialog">
	    	<div class="modal-content" style="border-radius:0px">
				...
				<?php if(isset($sellerProfile) && $sellerProfile && isset($launchModal) && $launchModal) { ?>
			   		<div class="row">
